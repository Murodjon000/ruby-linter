...
describe CheckError do 
    ...
    describe '#check_trailing_spaces' do 
        it 'should return trailing space error' do 
            ...
            expect(checker.errors[0]).to eql('line:4:22: Error: Trailing whitespace detected.')
        end
    end
    ...
    describe '#check_indentation' do 
        it 'should return indentation errors' do 
            ...
            expect(checker.errors[0]).to eql('line:5 IndentationWidth: Use 2 spaces for indentation.')
        end
    end
    ...
    describe '#tag_error' do 
        it 'should return tag errors' do 
            checker.tag_error
            expect(checker.errors[0]).to eql("line:4 Lint/Syntax: Unexpected/Missing token ']' Square Bracket")
        end
    end
    ...
    describe '#check_end_empty_line' do 
        it 'should return end errors' do 
            ...
            expect(checker.errors[0]).to eql("line:12 Extra empty line detected at block body end")
        end
    end
